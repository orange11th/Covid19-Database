...
<body>
	<h2>격리병동 DB (확진자 입력시 자동으로 등록됩니다)</h2>
</br>
<?php
...
//enter user name & password
	...
	$sql= "select id,to_char(hospitalenter,'yyyy-mm-dd') as hospitalenter, 
		to_char(leavehospital,'yyyy-mm-dd') as leavehospital,
		symptom from isolated order by hospitalenter";
...
<div class="but">
	...
	<button type="button"
                onclick="location.href='symptom.php'">증상 입력하기</button>
	 <button type="button"
